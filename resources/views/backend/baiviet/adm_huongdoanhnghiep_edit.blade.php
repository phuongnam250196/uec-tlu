                        ...
                        <div class="row">
                            <div class="col-xs-6 col-md-3">
                              <div class="form-group">
                                  ...
                                  <img id="avatar" class="thumbnail" src="{{url('local/storage/app/huongdoanhnghiep/'.$data->towardbusiness_img)}}" width="100%">
                              </div>
                            </div>
                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <label>Tiêu đề</label>
                                    <input required type="text" class="form-control" value="{{$data->towardbusiness_name}}" name="tt_title">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                  ...
                                  <textarea id="tt_content" class="ckeditor" name="tt_content" rows="10" style="width: 100%">{{$data->towardbusiness_content}}
                                  </textarea>
