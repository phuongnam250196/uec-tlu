            ...
            <div class="box box-info">
              <div class="box-header">
                  ...
                  <div class="pull-right box-tools">
                      @if(empty($intro))
                        <a class="btn btn-info btn-sm" href="{{url('admin/baiviet/gioithieu')}}">Thêm mới</a>
                      @else 
                      <a class="btn btn-info btn-sm" href="{{url('admin/baiviet/gioithieu/edit/'.$intro->id)}}">Cập nhật</a>
                      @endif
              ...
              <div class="box-body">
                ...
                <div class="">
                  <label>Tiêu đề</label>
                  <p>{{$intro->introuec_name}}</p>
                </div>
                <div class="">
                  <label>Ảnh minh học</label>
                 <p> <img src="{{asset('local/storage/app/gioithieuUEC/'.$intro->introuec_img)}}" width="100"></p>
                </div>
                <div>
                  <label>Nội dung</label>
                  <p>{!! $intro->introuec_content !!}</p>
                </div>
              </div>
