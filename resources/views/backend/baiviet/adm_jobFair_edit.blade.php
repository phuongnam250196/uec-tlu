                        ...
                        <div class="row">
                            <div class="col-xs-6 col-md-3">
                              <div class="form-group">
                                  ...
                                  <img id="avatar" class="thumbnail" src="{{url('local/storage/app/jobfair/'.$data->jobfair_img)}}" width="100%">
                              </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label>Tiêu đề</label>
                                    <input required type="text" class="form-control" value="{{$data->jobfair_name}}" name="tt_title">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                  ...
                                  <textarea id="tt_content" class="ckeditor" name="tt_content" rows="10" style="width: 100%">{{$data->jobfair_content}}
                                  </textarea>
