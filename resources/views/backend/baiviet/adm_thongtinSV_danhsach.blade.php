            ...
            <div class="box box-info">
              <div class="box-header">
                  ...
                  <div class="pull-right box-tools">
                      @if(empty($thongtin))
                        <a class="btn btn-info btn-sm" href="{{asset('admin/baiviet/thongtinsinhvien')}}">Thêm mới</a>
                      @else 
                      <a class="btn btn-info btn-sm" href="{{asset('admin/baiviet/thongtinsinhvien/edit/'.$thongtin->id)}}">Cập nhật</a>
                      @endif
              ...
              <div class="box-body">
                ...
                <div class="">
                  <label>Tiêu đề</label>
                  <p>{{$thongtin->infostudent_name}}</p>
                </div>
                <div class="">
                  <label>Ảnh minh học</label>
                 <p> <img src="{{asset('local/storage/app/thongtinSV/'.$thongtin->infostudent_img)}}" width="100"></p>
                </div>
                <div>
                  <label>Nội dung</label>
                  <p>{!! $thongtin->infostudent_content !!}</p>
                </div>
              </div>
