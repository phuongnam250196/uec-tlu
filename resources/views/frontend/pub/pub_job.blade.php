...
<section id="breadcrumb-link">
    <div class="container">
        <ul class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Job Fair</li>
        </ul>
    </div>
</section>
                ...
                <div class="thongtinsinhvien">
                    <div class="thongtinsinhvien-main">
                        <div class="thongtinsinhvien-title">
                            <h1 class="thongtinsinhvien-title-exp">{{$jobfair_first->jobfair_name}}</h1>
                        </div>
                        <div class="row thongtinsinhvien-row">
                            <div class="col-md-8 thongtinsinhvien-content">
                                {!! $jobfair_first->jobfair_content !!}
                            ...
                            <div class="col-md-4 thongtinsinhvien-img">
                                @foreach($jobfair_other as $other)
                                    <img src="{{asset('local/storage/app/jobfair/'.$other->jobfair_img)}}">
                                @endforeach
                            </div>
                        </div>
                    </div>
