...
<section id="breadcrumb-link">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{$ena->area_name}}</li>
        </ul>
    </div>
</section>
                        ...
                        <div class="col-md-9 pub_dn-col">
                            <div class="pub_dn-col-ab">
                                ...
                                <div class="alert alert-primary pub_dn-col-sum">
                                  <p><strong>Danh sách doanh nghiệp </strong> <br>Có tổng số <strong>{{$count}}</strong> doanh nghiệp khu vực <strong>{{$ena->area_name}}</strong>.</p> 
                                </div>
                                @foreach($enter_area as $enter)
